...
async function warning() {
    ...
    notification.MaterialSnackbar.showSnackbar({
        message: 'This website is still under construction! Please use with care! :) Best used with 375 X 667 Displays! Optimised for mobile use.'
    });
}
...
var studentsTable, uncollectedData;
loadTable();
...
function renderUncollected() {
    uncollectedData.innerHTML = "Total Uncollected Parcel : " + countUncollected;
}
        ...
        .then((snapshot) => {
            snapshot.docs.forEach(doc => {
                if (doc.exists) {
                    ...
                    uncollectedData.innerHTML = "Yay! You haven't yet receive any parcel!";
                }
